...
```
http://localhost:8000/kyon_mock/api/kyun/sightings
```
...
curl -i -s -X POST http://localhost:8001/services \
   --data name=kyon_service \
   --data url='http://127.0.0.1:5000/api/kyun/sightings'
curl -i -X POST http://localhost:8001/services/kyon_service/routes \
    --data 'paths[]=/kyon_mock' \
    --data name=kyon_route
```
...
curl -i -s -X POST http://localhost:8001/services \
   --data name=kyon_service \
   --data url='http://10.98.20.62:5000/api/kyun/sightings'
curl -i -X POST http://localhost:8001/services/kyon_service/routes \
    --data 'paths[]=/kyon_mock' \
    --data name=kyon_route
```
...
curl -i -s -X POST http://localhost:8001/services \
   --data name=kyon_service \
   --data url='http://10.98.20.62:5000/api/kyun'
curl -i -X POST http://localhost:8001/services/kyon_service/routes \
    --data 'paths[]=/kyon_mock' \
    --data name=kyon_route
```
